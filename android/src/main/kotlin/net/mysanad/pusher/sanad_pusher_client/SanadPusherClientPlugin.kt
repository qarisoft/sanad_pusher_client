...
class SanadPusherClientPlugin: FlutterPlugin, MethodCallHandler, ActivityAware,
...
//  private lateinit var channel : MethodChannel
  ...
  private val TAG = "SanadPusherClient"

  override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    methodChannel = MethodChannel(flutterPluginBinding.binaryMessenger, "sanad_pusher_client")
  ...
  private fun init(
    ...
    try {
      ...
      if (call.argument<String>("setHost") != null) options.setHost(call.argument("setHost")!!)
      if (call.argument<Int>("setWsPort") != null) options.setWsPort(call.argument("setWsPort")!!)
      if (call.argument<Int>("setWssPort") != null) options.setWssPort(call.argument("setWssPort")!!)
//      options.setHost("192.168.0.235")
...
//      options.setWsPort(6001)
  ...
  override fun authorize(channelName: String?, socketId: String?): String? {
    ...
    try {
      ...
      Log.i(TAG, "Pusher authorize error: $exception")
      result = "{ }"
      mutex.release()
    }
    mutex.acquire()
